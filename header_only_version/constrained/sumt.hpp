...
sumt(
    ...
    void* constr_data)
{
    return sumt_impl(init_out_vals, opt_objfn, opt_data, constr_fn, constr_data, nullptr);
}
...
sumt(
    ...
    algo_settings_t& settings)
{
    return sumt_impl(init_out_vals, opt_objfn, opt_data, constr_fn, constr_data, &settings);
}
