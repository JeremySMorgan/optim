...
broyden(
    ...
    void* opt_data)
{
    return broyden_impl(init_out_vals,opt_objfn,opt_data,nullptr);
}
...
broyden(Vec_t& init_out_vals, 
               ...
               algo_settings_t& settings)
{
    return broyden_impl(init_out_vals,opt_objfn,opt_data,&settings);
}
...
broyden(
    ...
    void* jacob_data)
{
    return broyden_impl(init_out_vals, opt_objfn, opt_data, jacob_objfn, jacob_data, nullptr);
}
...
broyden(
    ...
    algo_settings_t& settings)
{
    return broyden_impl(init_out_vals, opt_objfn, opt_data, jacob_objfn, jacob_data, &settings);
}
